...
public class MassekugelnNextSave extends GraphicsProgram {
	...
	public void konstStrukt(double maxx, double maxy, double maxz, double maxMass) {
		...
		for (int i = 0; i < strukt.length; i++) {
			...
			// else {masse = maxMass/Math.random();size=15;}
...
//		raumzeitneu(200);
	...
	public static void main(String[] args) {
		new MassekugelnNextSave().start(args);
	}
