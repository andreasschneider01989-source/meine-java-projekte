...
public class MassekugelnReloaded6 extends GraphicsProgram {
...
//		KreisPunkt[] strukt = struktsort(this.strukt);
		...
		for (int i = 0; i < strukt.length; i++) {
			...
			if (kp.posX * zoom + 900 < 2000 && kp.posX * zoom + 900 > 0 && kp.posY * zoom + 450 < 2000
					&& kp.posY * zoom + 450 > 0 && kp.size >= 1)
...
//			} 
				...
				masse = maxMass / 1836100 * Math.random();
				size = 1;
			}
...
//		drawKreisePunkte2(0.2);
	...
	public static void main(String[] args) {
		new MassekugelnReloaded6().start(args);
	}
