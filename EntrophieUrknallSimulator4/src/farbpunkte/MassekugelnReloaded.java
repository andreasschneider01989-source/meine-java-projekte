...
// Ausführen der Klasse MassekugelnReloaded
// Mouseklick
// Buttens einstellen: Anklicken an verschiedenen Bereichen zum ändern der Werte
// Zoom zwischen 0 und 1
// iter ca. 1000000 -> steps per mouseklick

//Execute the class MassekugelnReloaded
//mouse click
//Set buttens: Click on different areas to change the values
//Zoom between 0 and 1
//iter approx. 1000000 -> steps by mouse click



public class MassekugelnReloaded extends GraphicsProgram {
	...
	public void test2() {
//		//Bewegungserhaltung bei Kreisen
//		 ButtonCount[0][0]=1000;
//		//zoom
//		ButtonCount[0][1]=0.5;
//		//iter
//		ButtonCount[0][2]=1000000;
...
//		if(ButtonCount==null)ButtonCount=new double[1][15];
	...
	public static void main(String[] args) {
		new MassekugelnReloaded().start(args);
	}
