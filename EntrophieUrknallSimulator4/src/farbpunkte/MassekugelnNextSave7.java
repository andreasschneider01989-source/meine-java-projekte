...
public class MassekugelnNextSave7 extends GraphicsProgram {
...
//			double posZ = Math.random() * maxz;
			...
			double b2=255/masse;
			if(r2<0)r2=-r2; if(g2<0)g2=-g2; if(b2<0)b2=-b2;
...
//				b += 10;
			...
			strukt[i].dx=dx; strukt[i].dy=dy; strukt[i].dz=dz;
			strukt[i].nr = i;
...
//	}
	...
	public void drawKreisePunkteArray(double zoom, KreisPunkt[] struktArray) {
	...
	public KreisPunkt[] MatStrukToStruk(MaterieStruktur matStruk, int count) {
		int size = (int) Math.pow(2, matStruk.unterstufe);
		
		
		KreisPunkt[] strukt = new KreisPunkt[size];
		
		if(matStruk.unterstufe==0) {strukt[count]= matStruk.kreispunkt; count++;}
		else   {MatStrukToStruk(matStruk.unterstruktur, count);MatStrukToStruk(matStruk.unterstruktur, count);}
	...
	public void generateMatStrukt(int tiefe) {
		MaterieStruktur matStrukt = new MaterieStruktur(tiefe,0,1000,0,1000,0,1000,1000000);
		KreisPunkt[] strukt=MatStrukToStruk(matStrukt,0);
		drawKreisePunkteArray(zoom,strukt);
		
	}
	
//	public KreisPunk MatStrukToStrukRek(MaterieStruktur matStruk) {
//		
//	}
...
//		raumzeitneu(t);
	...
	public static void main(String[] args) {
		new MassekugelnNextSave7().start(args);
	}
